...
const borrow_zod_1 = require("./borrow.zod");
const createBorrow = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const parsed = borrow_zod_1.borrowValidationSchema.safeParse(req.body);
        if (!parsed.success) {
        ...
        const result = yield borrowService.createBorrow(parsed.data);
...
const getBorrowSummary = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const result = yield borrowService.getBorrowSummary();
        (0, sendResponse_1.default)(res, {
            success: true,
